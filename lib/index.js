...
var REGISTRY = '0xf5513bc073A86394a0Fa26F11318D5D30AeAf550';
var TLSDID = /** @class */ (function () {
    function TLSDID(pemPrivateKey, ethereumPrivateKey, provider) {
        this.attributes = [];
        this.pemPrivateKey = pemPrivateKey;
        this.provider = provider;
        this.wallet = new ethers_1.Wallet(ethereumPrivateKey, provider);
    }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        registry = new ethers_1.Contract(REGISTRY, TLSDIDRegistry_json_1.default.abi, this.provider);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        _a.sent();
                        return [3 /*break*/, 6];
                    case 5: throw 'setAttribute unsuccesfull';
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        _a.sent();
                        return [3 /*break*/, 6];
                    case 5: throw 'setExpiry unsuccesfull';
                    case 6: return [2 /*return*/];
                }
            });
        });
