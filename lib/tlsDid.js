...
var CERT_REGISTRY = '0xE7dec5fB47AefF013d738Ae960f8Cc6AB43f6361';
var TLSDID = /** @class */ (function () {
     ...
     * @param certs
     */
    TLSDID.prototype.registerCerts = function (certs) {
        return __awaiter(this, void 0, void 0, function () {
            var certRegistry, certRegistryWithSigner, _i, certs_1, cert, tx, receipt;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.domain) {
                        ...
                        _a.label = 1;
                    case 1:
                        if (!(_i < certs_1.length)) return [3 /*break*/, 5];
                        cert = certs_1[_i];
                        return [4 /*yield*/, certRegistryWithSigner.addCert(this.domain, cert)];
                    case 2:
                        tx = _a.sent();
                        return [4 /*yield*/, tx.wait()];
                    case 3:
