...
var TLSDIDCertRegistry_json_1 = __importDefault(require("tls-did-registry/build/contracts/TLSDIDCertRegistry.json"));
var utils_1 = require("./utils");
//TODO import from tls-did-registry or tls-did-resolver
var REGISTRY = '0xaF9BA0dFa7D79eA2d1cFD28996dEf081c29dA51e';
var CERT_REGISTRY = '0x4d7648dE110574047EEa4F525Fd7FD10c318018e';
var TLSDID = /** @class */ (function () {
     ...
     */
    function TLSDID(pemPrivateKey, ethereumPrivateKey, networkConfig) {
    ...
    TLSDID.prototype.connectToContract = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            var contract, _a, expiryBN, attributeCount, i, attribute, path, value, _b, certRegistry, chainCount, i, chain, certs;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 8:
                        ...
                        certRegistry = new ethers_1.Contract(this.certRegistry, TLSDIDCertRegistry_json_1.default.abi, this.provider);
                        return [4 /*yield*/, certRegistry.getChainCount(this.domain)];
                    case 9:
                        chainCount = _c.sent();
                        this.chains = [];
                        i = 0;
                        _c.label = 10;
                    case 10:
                        if (!(i < chainCount)) return [3 /*break*/, 13];
                        return [4 /*yield*/, certRegistry.getChain(this.domain, i)];
                    case 11:
                        chain = _c.sent();
                        certs = utils_1.chainToCerts(chain);
     ...
     * @param certs
     */
    TLSDID.prototype.registerChain = function (certs) {
        return __awaiter(this, void 0, void 0, function () {
            var certRegistry, certRegistryWithSigner, joinedCerts, tx, receipt;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.domain) {
                        ...
                        certRegistry = new ethers_1.Contract(this.certRegistry, TLSDIDCertRegistry_json_1.default.abi, this.provider);
                        certRegistryWithSigner = certRegistry.connect(this.wallet);
                        joinedCerts = certs.join('\n');
                        return [4 /*yield*/, certRegistryWithSigner.addChain(this.domain, joinedCerts)];
                    case 1:
                        tx = _a.sent();
                        return [4 /*yield*/, tx.wait()];
                    case 2:
