...
var TLSDID = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        events.sort(function (a, b) { return b.args.previousChange - a.args.previousChange; });
     ...
     */
    TLSDID.prototype.sign = function (key) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
     ...
     * @param {string[]}certs
     */
    TLSDID.prototype.addChain = function (certs) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
    ...
    TLSDID.prototype.delete = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.registry.remove(this.wallet.address)];
                    case 1:
                        tx = _a.sent();
                        return [4 /*yield*/, tx.wait()];
                    case 2:
