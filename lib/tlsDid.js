...
var TLSDID = /** @class */ (function () {
    ...
    TLSDID.prototype.getOwnership = function () {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var claimantsCountBN, claimantsCount, claimants, test;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 2:
                        claimants = _b.sent();
                        test = claimants.includes(this.wallet.address);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _b.label = 2;
                    case 2:
                        hash = tls_did_utils_2.hashContract(this.domain, 'TODO', this.attributes, this.expiry, [this.chain]);
