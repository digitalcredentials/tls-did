...
var TLSDID = /** @class */ (function () {
    ...
    TLSDID.prototype.connectToContract = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            var contract, _a, expiryBN, attributeCount, i, attribute, path, value, chainCount, i, chain, certs, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 6:
                        i++;
                        return [3 /*break*/, 4];
                    case 7: return [4 /*yield*/, contract.getChainCount()];
                    case 8:
                        chainCount = _c.sent();
                        i = 0;
                        _c.label = 9;
                    case 9:
                        if (!(i < chainCount)) return [3 /*break*/, 12];
                        return [4 /*yield*/, contract.getChain(i)];
                    case 10:
                        chain = _c.sent();
     ...
     * @param {string} key - Signing tls key in pem format
     */
    TLSDID.prototype.registerChain = function (certs, key) {
        return __awaiter(this, void 0, void 0, function () {
